...
first_direction_significant_features_View1 <- 1-Zero_Count_Direction_vec_1_3[,1,]

# View 2 Significant features

first_direction_significant_features_View2<- 1-Zero_Count_Direction_vec_2_3[,1,]

#names(first_direction_significant_features_View2) <- colnames(Data_Set_1$X_2_rna)

Summary_Analysis<-list(Shrinkage_calculator=Shrinkage_calculator,first_direction_significant_features_View1=first_direction_significant_features_View1,first_direction_significant_features_View2=first_direction_significant_features_View2, V1.dir.data.frame=V1.dir.data.frame, V2.dir.data.frame=V2.dir.data.frame, Direction_Vector_View_1=Direction_CCA_Vec1_thin, Direction_Vector_View_2=Direction_CCA_Vec2_thin, CC_bound=Zero_count_bounds,effective_size_first_CCA=effective_size_first_CCA, effective_size_log_likelihood=effective_size_log_likelihood,CCA_MCMC_summary=CCA_MCMC_summary)
