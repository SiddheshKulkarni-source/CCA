...
Once, we have established that MCMC convergence is appropriate from the traceplots and ESS, we go for posterior inference. 

## Posterior Inference (Point Estimates and Intervals)

We will perform inference using these samples.  Firstly, we consider the posterior means and the credible intervals for the canonical correlations.
