...
DFSM<-function(d,thin,burn_iter,mcmc_iter,X_1,X_2,CCA_select)
{
  ...
  { 
      ...
      
    {
      ...
      {   
        ...
        Phi_grand_MCMC_thin<-sigma_grand_cal(A_1_thin[,,i],A_2_thin[,,i],phi_post_1_thin[,,i],phi_post_2_thin[,,i],p1,p2)
...
# filename_Output <- paste0(20, "DFSM_BC_Output", sep = "")
# 
# save(DFSM_Output, file = paste(filename_Output, ".Rdata", sep = ""))
